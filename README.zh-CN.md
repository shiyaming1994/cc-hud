...
从 [**Releases**](https://github.com/shiyaming1994/cc-hud/releases) 页面下载最新的 `CC-HUD.dmg`,然后:

1. 打开 DMG,把 **CC HUD.app** 拖进 **Applications**
2. 解除 Gatekeeper 限制(本 app 未做 Apple 公证),**二选一**:终端执行 `xattr -cr "/Applications/CC HUD.app"`,或先双击 app(会被拦一下)再到 **系统设置 → 隐私与安全性** 点 **「仍要打开」**
